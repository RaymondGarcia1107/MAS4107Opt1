...
class HeatModel:
    ...
    def create_diagonal_matrix(self,diagonalElement,offDiagonalElement):
        ...
        try:
            ...
            data =[offDiagonalElement * np.ones(self.size - 1),diagonalElement*np.ones(self.size),offDiagonalElement * np.ones(self.size - 1)]
            offsets = [-1,0,1]
    ...
    def create_Model(self):
        ...
        finalMatrix.setdiag(np.ones((self.size * self.size) - self.size),self.size)
